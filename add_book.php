            ...
            <section>
                        ...
                        <div class="dropdown" style="padding:8px;">
                         <button class="dropbtn"> Book </button>
                            <div class="dropdown-content">
                              ...
                              <a href="manage_book.php" style="font-size:13px;"> View Books</a>
                            </div>
                        </div>
                ...
                <center>
                    <form action="" method="post">
                        <br>
                        Book Name<br><input type="text" name="bname" required><br><br>
                        Author No.<br><input type="number" name="aut_no" required><br><br>
                        Book No<br><input type="number" name="bookno" required><br><br>
...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `books` VALUES(null,'$_POST[bname]','$_POST[aut_no]','$_POST[bookno]',$_POST[price])";
